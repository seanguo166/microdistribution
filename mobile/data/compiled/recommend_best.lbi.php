...
<div class="item_show_box2 box1 region" style="overflow:hidden">
    ...
    <div id="picScroll3" class="picScroll3">
        ...
        <div class="bd1">
            <ul>
                <?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_50367600_1421009104');$this->_foreach['best_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['best_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_50367600_1421009104']):
        $this->_foreach['best_goods']['iteration']++;
?>
                <li><a href="<?php echo $this->_var['goods_0_50367600_1421009104']['url']; ?>"><img src="<?php echo $this->_var['site_url']; ?><?php echo $this->_var['goods_0_50367600_1421009104']['thumb']; ?>" /></a>
                <br/>
                <?php if ($this->_var['goods_0_50367600_1421009104']['promote_price'] != ""): ?> 
				<font style="font-size:8px">市场价</font><del style="font-size: .675rem;"><?php echo $this->_var['goods_0_50367600_1421009104']['market_price']; ?></del>
                <span class="price_s"> <?php echo $this->_var['goods_0_50367600_1421009104']['promote_price']; ?> </span> 
                <?php else: ?> 
				<font style="font-size:8px">市场价</font><del style="font-size: .675rem;"><?php echo $this->_var['goods_0_50367600_1421009104']['market_price']; ?></del>
                <span class="price_s"> <?php echo $this->_var['goods_0_50367600_1421009104']['shop_price']; ?> </span>
				
                <?php endif; ?>
                <br><?php echo sub_str(htmlspecialchars($this->_var['goods_0_50367600_1421009104']['name']),12); ?>
                </li>
